...
const EVTS = {
  tech: [
    ...
    {
      id:'live-wire', name:'Live Wire', icon:'🎙️',
      tag:'Simplify the complex. Speak the circuit.',
      size:'Individual', prize:'Cash Prize',
      format:{team:'Individual participation',prep:'5 minutes thinking time after topic assigned',duration:'2 to 5 minutes speech',mode:'English only; cue cards allowed'},
      desc:'Live Wire is a technical speaking challenge where participants explain complex electrical concepts in a simple, engaging way. Topics/terms are assigned 5 minutes before speaking. The talk must cover definition, working principle, and at least one practical application. Participants may carry bullet-point cue cards.',
      rules:['Individual event only.','Topic/term assigned 5 minutes before speaking.','Speech duration: 2 to 5 minutes.','Medium of communication: English only.','Talk must cover: definition, working principle, and one practical application.','Cue cards (bullet points only) are allowed — no reading from scripts.','Judge\'s decision on technical accuracy and presentation is final.'],
      judging:null,
    },
    {
      id:'core-clash', name:'Core Clash', icon:'⚙️',
      tag:'Draw it. Identify it. Beat the clock.',
      size:'2 Members', prize:'Cash Prize',
      format:{team:'Exactly 2 members (Designer + Processor)',rounds:'1 Timed Blitz Round',duration:'3 minutes per team',mode:'Whiteboard / Chart Paper drawing'},
      desc:'Core Clash tests the synergy between teammates through electrical symbol recognition. One member is the "Designer" who draws standard electrical components/symbols on a whiteboard while the "Processor" identifies them. Non-verbal only — no speaking, mouthing, or writing text. Speed and accuracy are key.',
      rules:['Team size: exactly 2 members.','One draws (Designer); one identifies (Processor).','Non-Verbal Only: No speaking, whispering, or hand gestures allowed.','No Text/Numbers: Drawer cannot write letters, numbers, or the component name.','Pass Policy: Maximum 2 "Passes" allowed if stuck.','All sketches must follow standard IEEE/IEC conventions.','All sketches must be on the provided whiteboard/chart paper only.','Duration: 3 minutes per team.'],
      judging:null,
    },
    {
  ...
  nontech: [
    ...
    {
      id:'dont-touch', name:"Don't Touch Bro!", icon:'🏐',
      tag:'Pass the ball — without your hands!',
      size:'Team (2–3)', prize:'Prize',
      format:{team:'2 to 3 members',mode:'Team relay',timing:'Timed event'},
      desc:"Don't Touch Bro! is a fun energetic game where participants must pass a ball using only their legs, head, or body — no hands allowed. Fastest team wins!",
      rules:['Team of 2 to 3 members.','No using hands to touch or pass the ball at any time.','Ball must be passed using legs, head, or body only.','Ball must be dropped into the bowl placed at the endpoint.','If any participant uses their hands, the team is disqualified or must restart.','The team that places the ball in the bowl in the shortest time wins.'],
      judging:null,
    },
    {
    ...
    {
      id:'sell-it', name:'Sell It Da!', icon:'🎤',
      tag:'Ad-making. Act confident. Sell anything.',
      size:'1–2 Members', prize:'Prize',
      format:{team:'1 to 2 members',prep:'Time given to prepare advertisement',duration:'Short performance pitch',mode:'Live act + audience'},
      desc:'Sell It Da! is a hilarious ad-making event where teams must create and perform a funny advertisement for a product assigned by the judges.',
      rules:['Team size: 1 to 2 members.','Product will be randomly assigned by judges on the day.','Teams must create a funny and convincing advertisement for the product.','Judges score on: creativity, humor, teamwork, confidence, and presentation.','Props available at the venue — teams may bring their own as well.'],
      judging:[['Creativity','20'],['Humor','20'],['Teamwork','20'],['Confidence','20'],['Presentation','20'],['Total','100 Points']],
    },
    {
